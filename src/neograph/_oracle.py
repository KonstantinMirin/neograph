...
# --- names _oracle.py imported and RE-EXPORTED before the split; the redirect
# --- factories were their only local consumers here.
from langchain_core.runnables import (
    Runnable,  # noqa: E402,F401
    RunnableConfig,
    RunnableLambda,
)
...
# --- extracted cluster (neograph-3ffdg.16), re-exported so existing
# --- `from neograph._oracle import ...` call sites keep resolving unchanged.
from neograph._redirect_factories import (  # noqa: E402,F401
...
from neograph.modifiers import Each, EachFailure, Oracle  # noqa: E402,F401
from neograph.naming import output_field_name, split_output_field
from neograph.node import (
    HasName,  # noqa: E402,F401
    TypeSpecStatic,
)
