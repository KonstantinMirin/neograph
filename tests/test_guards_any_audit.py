...
NEOGRAPH_ERROR_ALLOWLIST: dict[str, str] = {
    ...
    "modifiers.py:201": "AttributeError is the Python attribute-protocol contract (private-attr guard)",
    "modifiers.py:441": "Pydantic @field_validator boundary; ValueError is rolled into ValidationError",
    "modifiers.py:516": "Pydantic @field_validator boundary; ValueError is rolled into ValidationError",
