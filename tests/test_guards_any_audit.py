...
NEOGRAPH_ERROR_ALLOWLIST: dict[str, str] = {
    ...
    "forward.py:200": "NotImplementedError is the Python abstract-method idiom",
    "forward.py:229": "AttributeError is the Python attribute-protocol contract (hasattr depends on it)",
    "forward.py:258": "TypeError is the Python protocol contract for __bool__ misuse",
    "forward.py:264": "TypeError is the Python protocol contract for __iter__ misuse",
    "forward.py:291": "TypeError is the Python protocol contract for __bool__ misuse on _ConditionProxy",
