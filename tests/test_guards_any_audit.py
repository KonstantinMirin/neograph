...
NEOGRAPH_ERROR_ALLOWLIST: dict[str, str] = {
    ...
    "forward.py:197": "NotImplementedError is the Python abstract-method idiom",
    "forward.py:226": "AttributeError is the Python attribute-protocol contract (hasattr depends on it)",
    "forward.py:255": "TypeError is the Python protocol contract for __bool__ misuse",
    "forward.py:261": "TypeError is the Python protocol contract for __iter__ misuse",
    "forward.py:288": "TypeError is the Python protocol contract for __bool__ misuse on _ConditionProxy",
    ...
    "modifiers.py:434": "Pydantic @field_validator boundary; ValueError is rolled into ValidationError",
    "modifiers.py:509": "Pydantic @field_validator boundary; ValueError is rolled into ValidationError",
