...
NEOGRAPH_ERROR_ALLOWLIST: dict[str, str] = {
    ...
    "modifiers.py:267": "AttributeError is the Python attribute-protocol contract (private-attr guard)",
    "modifiers.py:507": "Pydantic @field_validator boundary; ValueError is rolled into ValidationError",
    "modifiers.py:582": "Pydantic @field_validator boundary; ValueError is rolled into ValidationError",
