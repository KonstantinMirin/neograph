# A legal minimal Portal DISPATCH node (route="decide", design §4.2): it
# ASSEMBLES cleanly (M1 — _validation_portal excludes route="decide" from the
...
# (_add_portal_dispatch wires it as a plain LINEAR node, NO Command). The
