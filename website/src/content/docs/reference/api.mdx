...
|-------|------|----------|---------|
| `uri` | `str` | yes |  |
| `mime` | `str | None` | no | `None` |
| `text` | `str | None` | no | `None` |
| `bytes_b64` | `str | None` | no | `None` |
| `size` | `int | None` | no | `None` |
...
|-------|------|----------|---------|
| `name` | `str` | yes |  |
| `modifier_set` | `ModifierSet` | no | `<factory:ModifierSet>` |
| `description` | `str` | no | `''` |
| `nodes` | `list[neograph._ir_protocols.ConstructItem]` | no | `<factory:list>` |
| `input` | `type[pydantic.main.BaseModel] | None` | no | `None` |
| `output` | `type[pydantic.main.BaseModel] | None` | no | `None` |
| `llm_config` | `LlmConfig` | no | `<factory:LlmConfig>` |
| `renderer` | `neograph.renderers.Renderer | None` | no | `None` |
...
| `over` | `str` | yes |  |
| `key` | `str` | yes |  |
| `on_error` | `Literal['raise', 'collect']` | no | `'raise'` |
...
| Field | Type | Required | Default |
|-------|------|----------|---------|
| `when` | `str | collections.abc.Callable[[Any], bool]` | yes |  |
| `max_iterations` | `int` | no | `10` |
| `on_exhaust` | `str` | no | `'error'` |
| `history` | `bool` | no | `False` |
...
| `name` | `str` | yes |  |
| `modifier_set` | `ModifierSet` | no | `<factory:ModifierSet>` |
| `mode` | `Literal['think', 'agent', 'act', 'scripted']` | no | `'think'` |
| `inputs` | `Any` | no | `None` |
| `outputs` | `Any` | no | `None` |
| `model` | `str | None` | no | `None` |
| `prompt` | `str | None` | no | `None` |
| `llm_config` | `LlmConfig` | no | `<factory:LlmConfig>` |
| `tools` | `list[neograph.tool.Tool | langchain_core.tools.base.BaseTool]` | no | `[]` |
| `scripted_fn` | `str | None` | no | `None` |
| `raw_fn` | `neograph.node.RawNodeFn | None` | no | `None` |
| `fan_out_param` | `str | None` | no | `None` |
| `renderer` | `neograph.renderers.Renderer | None` | no | `None` |
| `context` | `list[str] | None` | no | `None` |
| `skip_when` | `neograph.node.SkipPredicate | None` | no | `None` |
| `skip_value` | `neograph.node.SkipValueFactory | None` | no | `None` |
| `gate_tools_when` | `collections.abc.Callable | str | None` | no | `None` |
| `oracle_gen_type` | `type[pydantic.main.BaseModel] | None` | no | `None` |
...
| `merge_prompt` | `str | None` | no | `None` |
| `merge_model` | `str` | no | `'reason'` |
| `merge_fn` | `str | None` | no | `None` |
| `merge_pre_process` | `neograph.modifiers.MergePreProcess | None` | no | `None` |
| `merge_post_process` | `neograph.modifiers.MergePostProcess | None` | no | `None` |
| `merge_fallback` | `neograph.modifiers.MergeFallback | None` | no | `None` |
...
|-------|------|----------|---------|
| `tool_name` | `str` | yes |  |
| `args` | `dict[str, Any]` | no | `<factory:dict>` |
| `producer_idempotent` | `bool` | no | `False` |
...
| `kind` | `str` | yes |  |
| `server` | `str` | yes |  |
| `producing_call` | `ProducingCall` | yes |  |
| `mime` | `str | None` | no | `None` |
| `size` | `int | None` | no | `None` |
| `fetched_at` | `str | None` | no | `None` |
| `ttl_ms` | `int | None` | no | `None` |
...
| `name` | `str` | yes |  |
| `budget` | `int` | no | `0` |
| `config` | `dict[str, Any]` | no | `<factory:dict>` |
| `idempotent` | `bool` | no | `False` |
