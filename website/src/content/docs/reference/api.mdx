...
{/* test-skip: generated API signature (declaration, not runnable) */}
```python
Portal(to: list[str] | None = None, route: str = 'goto', max_hops: int = 10, on_exhaust: Literal['error', 'exit'] = 'error', spec_field: str | None = None, input_field: str | None = None, output: type[pydantic.main.BaseModel] | str | None = None, scripted: dict[str, collections.abc.Callable] | None = None, conditions: dict[str, collections.abc.Callable] | None = None, on_invalid: Literal['raise'] = 'raise', max_depth: int | None = None)
```
...
| <span id="portal-on_invalid"></span>`on_invalid` | `Literal['raise']` | no | `'raise'` |
