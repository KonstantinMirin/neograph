...
{/* test-skip: generated API signature (declaration, not runnable) */}
```python
Portal(to: list[str] | None = None, route: str = 'goto', trigger: Optional[Literal['output', 'tool']] = None, max_hops: int | None = None, on_exhaust: Optional[Literal['error', 'exit']] = None, name: str | None = None, spec_field: str | None = None, input_field: str | None = None, output: type[pydantic.main.BaseModel] | str | None = None, scripted: dict[str, collections.abc.Callable] | None = None, conditions: dict[str, collections.abc.Callable] | None = None, on_invalid: Literal['raise', 'route_to_error'] = 'raise', error_handler: str | None = None, max_depth: int | None = None)
```
...
| <span id="portal-trigger"></span>`trigger` | `Optional[Literal['output', 'tool']]` | no | `None` |
| <span id="portal-max_hops"></span>`max_hops` | `int | None` | no | `None` |
| <span id="portal-on_exhaust"></span>`on_exhaust` | `Optional[Literal['error', 'exit']]` | no | `None` |
