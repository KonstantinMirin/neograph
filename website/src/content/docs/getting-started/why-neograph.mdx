...
@node(output=ResearchResult, prompt='research', model='fast',
...
@node(output=Jokes, prompt='generate', model='fast',
...
@node(output=Analysis, prompt='analyze', model='fast',
...
@node(output=Report, prompt='report', model='fast')
