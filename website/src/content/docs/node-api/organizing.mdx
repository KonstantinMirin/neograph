...
{/* test-skip: references an illustrative external module `pipelines` (not part of neograph) */}
```python
# pipelines/full.py
...
{/* test-skip: illustrative fragment: references `enrich` defined in the page narrative, not in a runnable block */}
```python
