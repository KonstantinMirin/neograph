...
{/* test-skip: snippet not runnable as written (ValidationError: 1 validation error for Node name   Field required [type=missing, input_value={'outputs': <class '__mai...tract) */}
```python
