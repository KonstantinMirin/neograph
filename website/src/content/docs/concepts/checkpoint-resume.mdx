...
{/* test-skip: illustrative fragment: references `pipeline_v1` defined in the page narrative, not in a runnable block */}
```python
...
{/* test-skip: illustrative fragment: references `run` defined in the page narrative, not in a runnable block */}
```python
