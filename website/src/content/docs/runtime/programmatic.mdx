...
validate = Node(
    "validate", mode="think", output=ValidationResult,
...
pipeline = Construct("broken", nodes=[
    Node("decompose", mode="think", output=Claims, ...),
    Node("verify", mode="think", inputs=ClusterGroup, output=MatchResult, ...),
])
