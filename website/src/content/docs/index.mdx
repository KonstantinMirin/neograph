...
48 compile-time checks backed by a [rustc-style fixture suite](/concepts/check-cli/). If it compiles, it runs. Validate any pipeline without executing: `neograph check my_pipeline.py`.
...
999 tests. 99% coverage. MIT license. Built on [LangGraph](https://github.com/langchain-ai/langgraph).
